...
public class EqualBottomBarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager = (ViewPager) findViewById(R.id.view_pager_equal);
        mBubbleNavigationLinearView = (BubbleNavigationLinearView) findViewById(R.id.equal_navigation_bar);

        // TODO 添加所需的Fragment
        mFragmentList.add(new ScreenSlidePageFragment("Shop", R.color.blue_inactive));
        mFragmentList.add(new ScreenSlidePageFragment("Pics", R.color.purple_inactive));
        mFragmentList.add(new ScreenSlidePageFragment("Call", R.color.green_inactive));
